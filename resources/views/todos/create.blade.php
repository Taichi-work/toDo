<x-app-layout>
    ...
    <div class="w-full max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div class="bg-white/80 backdrop-blur-md p-6 sm:p-10 rounded-[2.5rem] shadow-[0_20px_60px_rgb(0,0,0,0.08)] border border-slate-200/50 transition-all duration-500 hover:shadow-[0_25px_70px_rgb(99,102,241,0.15)]">
            <form method="POST" action="{{ route('todos.store') }}" class="space-y-6 sm:space-y-8">
                @csrf
                ...
                <div class="space-y-3">
                    ...
                    <div class="relative group">
                        <input type="text" name="title" id="title"
                            maxlength="50"
                            placeholder="例: 牛乳を買う、プロジェクトの資料作成..."
                            autofocus
                ...
                <div class="pt-4 sm:pt-6 space-y-3 sm:space-y-4">
                    <button
                        type="submit"
                        class="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold py-4 sm:py-5 rounded-3xl transition-all duration-300 shadow-lg shadow-indigo-500/30 hover:shadow-xl hover:shadow-indigo-500/40 active:scale-[0.98] text-base sm:text-lg group relative overflow-hidden"
                    >
